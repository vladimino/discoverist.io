...
{
    private const PARAM_TEAM1_ID        = 'team1ID';
    private const PARAM_TEAM2_ID        = 'team2ID';
    private const PARAM_CUSTOM_TEAM1_ID = 'team1IDcustom';
    private const PARAM_CUSTOM_TEAM2_ID = 'team2IDcustom';
    ...
    public function indexAction(Request $request): Response
    {
        ...
        $errorMessage  = '';
        $customTeam1ID = (int)$request->get(self::PARAM_CUSTOM_TEAM1_ID);
        $customTeam2ID = (int)$request->get(self::PARAM_CUSTOM_TEAM2_ID);
